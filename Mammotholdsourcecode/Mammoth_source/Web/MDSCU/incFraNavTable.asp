...
'		- The parent window of the frame this is in has the following:
'			<IFRAME Name="fraMain" src="admLoading.asp" scrolling="no" height="308" width="655" frameborder="0"></IFRAME>
'			<Div Style="position:relative; top:-20" ID="NavFooter"></Div>
...
Function NavData(db, strSQL, intNavPgSize, intNavPage, intNavNumRecs)
	...
	If rsData.EOF then
		strData = "<tr><td colspan=9 align=""center"" Class=""data"">No records were found.</td></tr>"
	End IF	

	Do While not rsData.EOF
		strData = strData & DoDataRow(db, rsData)		
...
Function NavFooter(strSQL, intNavPgSize, intNavPage, intNavNumRecs, intNavTableWidth)
...
'	End If
	...
	strFtr = strFtr & "<br><table border=0 cellspacing=0 width=" & intnavtablewidth & "><tr>"
	...
	Else
		strFtr = strFtr & "<a class=lnkHeader href=""""" & strNavPageFile & "intNavPage="  & intFirstPgNum - intNavPgNumsToShow & """"">PREV</a>&nbsp;&nbsp;"
	End If
	...
	For intNavPgX = intFirstPgNum to (intFirstPgNum + (intNavPgNumsToShow-1))
		...
		Elseif intNavPgX <= intNavPgCount then
			strFtr = strFtr & "<a  class=lnkHeader href=""""" & strNavPageFile & "intNavPage="  & intNavPgX & """"">&nbsp;" & intNavPgX & "&nbsp;</a>"
		Else
	...
	Else
		strFtr = strFtr & "<a class=lnkHeader target=""""fraMain"""" href=""""" & strNavPageFile & "intNavPage="  & intFirstPgNum + intNavPgNumsToShow & """"">&nbsp;&nbsp;NEXT</a>"
	End If
	strFtr = strFtr & "</td>"

	'*** Show the page count
	strFtr = strFtr & "<td align=right class=header>Page " & intNavPage & " of <a target=fraMain class=lnkHeader href=""""" & strNavPageFile & "intNavPage="  & intNavPgCount & """"">&nbsp;" & intNavPgCount & "&nbsp;</A></td>"
