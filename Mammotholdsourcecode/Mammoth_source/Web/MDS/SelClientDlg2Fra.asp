...
'	strSQL = " SELECT top 50 ClientID, fname, lname, addr1, city, Phone"&_
'			" into tbl_tempClient FROM client(NOLOCK)"&_
'			" WHERE (left(fname,"& len(request("strfname")) &") =  Left('" & request("strfname") & "',"& len(request("strfname")) &")"&_
'			" and (left(Lname,"& len(request("strLname")) &") =  Left('" & request("strLname") & "',"& len(request("strLname")) &")"&_
'			" Order By lname,fname"
...
'	strSQL = " SELECT top 50 ClientID, fname, lname, addr1, city, Phone"&_
'			"  into tbl_tempClient  FROM client(NOLOCK)"&_
'			" WHERE (left(Lname,"& len(request("strLname")) &") =  Left('" & request("strLname") & "',"& len(request("strLname")) &")"&_
'			" Order By lname,fname"
