...
Dim dbMain, intVenID, strVendor, strVenContact, strVenaddr1, strVenaddr2, strVencity, strVenst, strVenzip,_
...
If intVenID="" OR intVenID>0 Then 
...
<body class="pgbody">
<form method="POST" name="frmMain" action="NewVendorDlgFra.asp">
...
Sub UpdateData(dbMain,intVenID)
	...
	IF intVenID = 0 then
		...
		strSQL= "Insert into Vendor (VenID,Vendor,VenContact,Venaddr1,Venaddr2,Vencity,Venst,Venzip,"&_
			"VenPhone,VenFax,VenEmail,VenURL) Values ("&_
			intVenID &","&_
	...
	ELSE
		strSQL= "UPDATE Vendor  set "&_
				...
				"Venzip ='" & SQLReplace(Request("strzip")) &"',"&_
