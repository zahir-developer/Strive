...
<table style="width:98%; border-collapse:collapse" class="Data">
	<tr>
     <td class="Header" style="width:90px" >Date</td>
    <td class="Header"  style="width:90px">Type</td>
    <td class="Header"  style="width:90px">Ticket #</td>
    <td class="Header"  style="width:90px">Amount</td>
    <td class="Header"  style="width:300px">Note</td>
    </tr>
	<%=DoDataRow()%>
...
Function DoDataRow()
	...
	strSQL =" SELECT top(20) TXDte,TXType,TXAmt,TXrecID,TXNote "&_
			...
			" order by CustAccHist.TXDte desc"
