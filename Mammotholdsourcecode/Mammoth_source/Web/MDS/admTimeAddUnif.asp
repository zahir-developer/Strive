...
<body class="pgbody">
    <div style="text-align: center;">
        ...
        <iframe name="fraMain" src="admTimeAddUnifFra.asp?intUserID=<%=intUserID%>&hdnSheetID=<%=hdnSheetID%>&strGTotal=<%=strGTotal%>&LocationID=<%=LocationID%>&LoginID=<%=LoginID%>" style="height: 210px; width: 430px;" frameborder="0"></iframe>
    </div>
</body>
</html>
<%
