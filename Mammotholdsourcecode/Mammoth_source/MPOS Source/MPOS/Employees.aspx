<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Employees.aspx.cs" Inherits="MPOS.Employees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <iframe name="body" style="width:100%; height:600px;"    seamless="seamless" src="<%=RedirectUrl.Text%>AdmUsers.asp?LocationID=<%=LocationID.Text %>&LoginID=<%=LoginID.Text %>"></iframe>
