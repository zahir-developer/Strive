<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EODScreen.aspx.cs" Inherits="MPOS.EODScreen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <asp:TextBox ID="RedirectUrl" runat="server" Visible="false"></asp:TextBox>
     <iframe name="body" style="width:100%; height:800px;"  scrolling="no"  seamless="seamless" src="<%=RedirectUrl.Text%>rptEndofDay.asp?LocationID=<%=LocationID.Text %>&LoginID=<%=LoginID.Text %>"></iframe>
</asp:Content>
