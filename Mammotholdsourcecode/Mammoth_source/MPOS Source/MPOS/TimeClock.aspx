<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TimeClock.aspx.cs" Inherits="MPOS.TimeClock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <iframe name="body" style="width:100%; height:600px; " scrolling="no" seamless="seamless" src="<%=RedirectUrl.Text%>timelogin.asp?LocationID=<%=LocationID.Text %>"></iframe>
</asp:Content>
