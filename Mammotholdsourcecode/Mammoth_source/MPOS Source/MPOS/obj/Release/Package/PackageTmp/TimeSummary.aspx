<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TimeSummary.aspx.cs" Inherits="MPOS.TimeSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:ReportViewer ID="ReportViewer1" runat="server" ViewMode="PrintPreview"  Width="100%" Height="1200px" BackColor="White" >
        <typereportsource typename="MPOSReportLibrary.TimeSummary, MPOSReportLibrary, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null">
        </typereportsource>
