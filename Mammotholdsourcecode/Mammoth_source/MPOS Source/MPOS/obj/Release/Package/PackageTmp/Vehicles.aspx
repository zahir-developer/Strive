<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vehicles.aspx.cs" Inherits="MPOS.Vehicles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <asp:TextBox ID="RedirectUrl" runat="server" Visible="false"></asp:TextBox>
     <iframe name="body" style="width:100%; height:600px;"    seamless="seamless" src="<%=RedirectUrl.Text%>VehList.asp?LocationID=<%=LocationID.Text %>&LoginID=<%=LoginID.Text %>"></iframe>
</asp:Content>
