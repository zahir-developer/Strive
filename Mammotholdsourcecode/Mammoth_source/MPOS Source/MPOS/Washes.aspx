<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Washes.aspx.cs" Inherits="MPOS.Washes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <iframe name="body" style="width:100%; height:600px; " scrolling="no" seamless="seamless" src="<%=RedirectUrl.Text%>wash.asp?LocationID=<%=LocationID.Text %>&LoginID=<%=LoginID.Text %>"></iframe>
</asp:Content>
