...
CREATE PROCEDURE [CON].[uspGetAllEmployeeDetail]
...
INNER JOIN StriveCarSalon.tblEmployeeDetail empdet on emp.EmployeeId = empdet.EmployeeId 
WHERE ISNULL(emp.IsDeleted,0) = 0 AND

empdet.EmployeeDetailId is NOT NULL 
