CREATE TABLE [CON].[tblEmployeeDetail] (
    ...
    CONSTRAINT [FK_tblEmployeeDetail_EmployeeId] FOREIGN KEY ([EmployeeId]) REFERENCES [CON].[tblEmployee] ([EmployeeId])
);


GO
CREATE NONCLUSTERED INDEX [IX_tblEmployeeDetail_EmployeeId]
    ON [CON].[tblEmployeeDetail]([EmployeeId] ASC);
