CREATE TABLE [CON].[tblChatMessage] (
    ...
    CONSTRAINT [FK_tblChatMessage_ReminderFrequencyId] FOREIGN KEY ([ReminderFrequencyId]) REFERENCES [CON].[tblReminderFrequency] ([ReminderFrequencyId])
);
