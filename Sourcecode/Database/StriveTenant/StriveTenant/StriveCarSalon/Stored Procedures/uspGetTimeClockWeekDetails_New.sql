CREATE PROCEDURE [StriveCarSalon].[uspGetTimeClockWeekDetails_New]
@EmployeeId INT,
@LocationId INT,
@StartDate DATETIME,
@EndDate DATETIME
...
Description         : To Get TimeClock Details for an Employee for a Week, EXEC [uspGetTimeClockDetails] 1,1,'2020-08-09','2020-08-15' -–Percentage level Detail 
