...
CREATE PROCEDURE [StriveCarSalon].[uspGetItemListByTicketNumber_Test] -- [StriveCarSalon].[uspGetItemListByTicketNumber_Test] '583863,354624'
...
--Address
 ...
 WHERE 
	 ','+@TicketNumber+',' LIKE '%,'+CONVERT(VARCHAR(50),tblj.TicketNumber)+',%'
