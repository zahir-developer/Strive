...
as begin
    Select tbljb.TicketNumber,
		   ...
		   Sum(((tbljbI.Price * @Quantity) + tbljp.TaxAmount +tbljp.Cashback)- tblgc.TotalAmount ) as GrandTotal 
		   ...
		   Group by tbljb.TicketNumber,tbljp.TaxAmount,tbljp.Cashback,tblgc.TotalAmount,tblsr.ServiceName,tbljbI.Price,tbler.valuedesc
