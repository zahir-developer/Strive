...
Select top 1 @GiftCardId = GiftCardId, @TotalAmount = TotalAmount, @ActivationDate = ActivationDate from tblGiftCard where GiftCardCode = @GiftCardNumber

Select @TransactionAmount = SUM(TransactionAmount) from tblGiftCardHistory
