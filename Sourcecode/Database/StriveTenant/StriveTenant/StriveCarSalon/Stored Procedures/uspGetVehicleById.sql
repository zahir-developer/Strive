...
--[StriveCarSalon].[uspGetVehicleById] 187361
...
SELECT
	...
	,ISNULL(cvl.VehicleColor,0) AS ColorId
	,cvl.Upcharge
	,cvl.Barcode
	,cvl.MonthlyCharge	
	,cvl.locationId
...
LEFT join tblClient cl on cvl.ClientId =cl.ClientId
...
WHERE cvl.VehicleId = @VehicleId-- AND ISNULL(cvl.IsDeleted,0)=0
