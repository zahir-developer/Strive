...
CREATE PROCEDURE [StriveCarSalon].[uspGetDashboardStatistics_New] --[StriveCarSalon].[uspGetDashboardStatistics] 2060,'2020-12-28','2020-12-28'
...
AND (tbll.LocationId = @LocationId OR @locationId = NULL or @LocationId = 0)
