...
CREATE PROCEDURE [StriveCarSalon].[uspGetVehicleMembership]
(@MembershipId int =null)
As Begin
SELECT  tblm.MembershipName,
        tblcm.ClientVehicleId
      FROM [StriveCarSalon].[tblMembership]  tblm 
	       Inner Join [StriveCarSalon].[tblClientVehicleMembershipDetails] tblcm ON tblm.MembershipId = tblcm.MembershipId
