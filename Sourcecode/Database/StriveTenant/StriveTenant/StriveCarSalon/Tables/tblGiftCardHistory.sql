CREATE TABLE [StriveCarSalon].[tblGiftCardHistory] (
    ...
    CONSTRAINT [FK_StrivecarSalon_tblGiftCardHistory_JobPaymentDetailId] FOREIGN KEY ([JobPaymentDetailId]) REFERENCES [StriveCarSalon].[tblJobPaymentDetail] ([JobPaymentDetailId]),
