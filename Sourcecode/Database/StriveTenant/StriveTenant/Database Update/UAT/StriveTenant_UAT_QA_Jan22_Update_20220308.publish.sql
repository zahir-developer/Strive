/*
Deployment script for StriveTenant_UAT_QA_Jan22
...
GO
PRINT N'Altering [StriveCarSalon].[tblEmployee]...';


GO
ALTER TABLE [StriveCarSalon].[tblEmployee]
...
END
GO
PRINT N'Altering [StriveCarSalon].[uspGetCreditAccountBalance]...';
...
--=================================================
ALTER PROCEDURE [StriveCarSalon].[uspGetCreditAccountBalance]     
@ClientId varchar(10),
@month INT,
@year INT
as    
...
END
GO
PRINT N'Creating [StriveCarSalon].[uspGetCheckListNotification]...';
