...
insert into
[StriveCarSalon].[tblCodeCategory]  (category,isDeleted)  values ('ServiceCategory',0)
...
Insert into [StriveCarSalon].[tblCodeValue] ( codeValue,Description, CategoryId)  values
