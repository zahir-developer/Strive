...
CREATE PROCEDURE [StriveCarSalon].[uspSaveCashRegisterMain]
...
WHEN MATCHED 
THEN
--set @DrawerId = select DrawerId from [StriveCarSalon].[tblDrawer] where LocationId = SRC.LocationId;
...
VALUES (SRC.CashRegisterType, SRC.LocationId,(SELECT Top 1 DrawerId FROM [StriveCarSalon].[tblDrawer] where LocationId = SRC.LocationId),
SRC.UserId,
SRC.EnteredDateTime,
SRC.CashRegCoinId,
SRC.CashRegBillId,
