CREATE TABLE [StriveLimoSalon].[tblEmployeeLiabilityDetail] (
    ...
    CONSTRAINT [FK_tblEmployeeLiabilityDetail_tblEmployeeLiability] FOREIGN KEY ([LiabilityId]) REFERENCES [StriveLimoSalon].[tblEmployeeLiability] ([LiabilityId])
);
