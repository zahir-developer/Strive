...
TRG.Country = SRC.Country, TRG.Zip = SRC.Zip, TRG.Fax = SRC.Fax, TRG.IsActive = SRC.IsActive 

WHEN NOT MATCHED  THEN

INSERT (RelationshipId, Address1, Address2,PhoneNumber,PhoneNumber2,Email,City,State,Country,Zip,Fax,IsActive)
VALUES (@InsertedVendorId, SRC.Address1, SRC.Address2,SRC.PhoneNumber,SRC.PhoneNumber2,SRC.Email,SRC.City,SRC.State,SRC.Country,SRC.ZIP,SRC.FAX,SRC.IsActive);
