...
namespace Strive.ResourceAccess
{
    public class WashesRal : RalBase
    {
        ...
        public List<AllWashesViewModel> GetAllWashTime(int locationId)
        {
            ...
            return db.Fetch<AllWashesViewModel>(EnumSP.Washes.USPGETALLJOB.ToString(), _prm);
        }
        ...
        public WashDetailViewModel GetWashTimeDetail(int id)
        {
            ...
            _prm.Add("@JobId", id);
            var result = db.FetchMultiResult<WashDetailViewModel>(EnumSP.Washes.USPGETJOBBYID.ToString(), _prm);
            return result;
        }
        ...
        public List<ClientVehicleViewModel> GetMembershipListByVehicleId(int vehicleId)
        {
            ...
            var result = db.Fetch<ClientVehicleViewModel>(EnumSP.Membership.uspGetMembershipListByVehicleId.ToString(), _prm);
            return result;
        }
        public bool DeleteWashes(int id)
        {
            _prm.Add("@JobId", id);
            db.Save(EnumSP.Washes.USPDELETEWASHES.ToString(), _prm);
            return true;
        }
    }
}