...
namespace Strive.BusinessLogic.Details
{
    public class DetailsBpl : Strivebase, IDetailsBpl
    {
        ...
        public Result GetDetailCustomerPrint(PrintTicketDto printTicketDto)
        {
            return ResultWrap(CustomerPrintReceipt, printTicketDto, "CustomerPrint");
        }

        public string CustomerPrintReceipt(PrintTicketDto print)
        {
            ...
            var body = "^XA^AJN,30^FO50,50^FD" + "Client:" + print.Job.ClientName + "^FS^AJN,30^FO540,50^FD" + print.Job.PhoneNumber + "^FS";
            ...
            body += "^AJN,30^A0N,30,30^FO480," + (yaxis + 100) + "^FD" + "Air Fresheners" + "^FS";
            ...
            body += "^AJN,20^FO50,600^FD" + "In:" + print.Job.InTime + "^FS" +
            "^AJN,20^FO50,640^FD" + "Out:" + print.Job.InTime + "^FS" +
            "^AJN,20^FO50,680^FD" + "Est " + EstimatedTime.ToString() + "Min^FS";
