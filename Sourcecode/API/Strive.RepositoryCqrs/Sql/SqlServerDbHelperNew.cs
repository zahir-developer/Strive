...
namespace Strive.RepositoryCqrs
{
    ...
    /// </summary>
    public class SqlServerDbHelperNew : IDbHelper
    {
        /// <summary>
        /// Creates a new instance of <see cref="SqlServerDbHelperNew"/> class.
        /// </summary>
        public SqlServerDbHelperNew()
        ...
        public SqlServerDbHelperNew(IResolver<string, Type> dbTypeResolver)
        {
        ...
        /// <summary>
        /// Gets the type resolver used by this <see cref="SqlServerDbHelperNew"/> instance.
        /// </summary>
