...
namespace Messenger.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
               // swag.SwaggerDoc("v1", new Swashbuckle.AspNetCore.Swagger.Info { Title = "StriveMessengerApi", Version = "v1" });
        ...
        {
            app.UseSwagger();
            //app.UseSwaggerUI(options => { options.SwaggerEndpoint(Configuration["StriveMessengerSettings:VirtualDirectory"] + "swagger.json", "Strive-Admin - v1"); });
            app.UseSwaggerUI(options => { options.SwaggerEndpoint("/swagger/v1/swagger.json", "StriveMessengerApi"); });
