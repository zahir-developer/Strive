...
namespace Strive.Core.Utils
{
    public class ApiUtils
    {
        ...
        public const string AZURE_URL_TEST = "https://mammothuatapi-qa.azurewebsites.net"; //"https://mammothuatapi.azurewebsites.net";//"https://mammothuatapi-dev.azurewebsites.net";
