...
namespace Strive.Core.Services.Implementations
{
    public class AdminService : IAdminService
    {
        ...
        public async Task<AvailableScheduleSlots> GetScheduleSlots()
        {
            return await _restClient.MakeApiCall<AvailableScheduleSlots>(ApiUtils.URL_SCHEDULE_TIME_SLOTS, HttpMethod.Post);
        }
    }
