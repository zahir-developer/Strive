...
namespace Strive.Core.Services.Implementations
{
    public class AdminService : IAdminService
    {
        ...
        public async Task<CheckOutVehicleDetails> CheckOutVehicleDetails(Models.Employee.Messenger.MessengerContacts.GetAllEmployeeDetail_Request CheckoutInfo)
        {
            return await _restClient.MakeApiCall<CheckOutVehicleDetails>(ApiUtils.URL_CHECKOUT_DETAILS, HttpMethod.Post, CheckoutInfo);
        }
