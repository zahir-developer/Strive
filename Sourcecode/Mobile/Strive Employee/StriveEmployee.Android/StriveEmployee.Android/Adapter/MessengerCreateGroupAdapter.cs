...
namespace StriveEmployee.Android.Adapter
{
    ...
    public class MessengerCreateGroupAdapter : RecyclerView.Adapter, View.IOnClickListener, View.IOnLongClickListener
    {
        ...
        public void OnClick(View v)
        {
            ...
            if(MessengerTempData.SelectedParticipants.EmployeeList.Employee.Contains(contacts[position]))
            {
                var index = MessengerTempData.SelectedParticipants.EmployeeList.Employee.IndexOf(contacts[position]);
                MessengerTempData.SelectedParticipants.EmployeeList.Employee.RemoveAt(index);
                v.SetBackgroundColor(Color.Transparent);
            }
            else
            {
                MessengerTempData.SelectedParticipants.EmployeeList.Employee.Add(contacts[position]);
