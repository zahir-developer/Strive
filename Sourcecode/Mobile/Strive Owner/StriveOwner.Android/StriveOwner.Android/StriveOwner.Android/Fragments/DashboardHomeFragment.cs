...
namespace StriveOwner.Android.Resources.Fragments
{
    ...
    private async void LocationBtn_Click(object sender, EventArgs e)
        ...
        private void BayDetails()
        {
            ...
            if (ViewModel.dbSchedule != null && ViewModel.dbSchedule.DetailsGrid != null && ViewModel.dbSchedule.DetailsGrid.BayDetailViewModel != null && ViewModel.dbSchedule.DetailsGrid.BayJobDetailViewModel != null)
            {
