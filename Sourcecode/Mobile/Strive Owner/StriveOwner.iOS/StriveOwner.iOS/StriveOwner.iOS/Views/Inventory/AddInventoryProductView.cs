...
{
    public partial class AddInventoryProductView : MvxViewController<InventoryEditViewModel>
    {
        //public AddInventoryProductView() : base("AddInventoryProductView", null)
        //{
        //}
        ...
        public override void ViewDidLoad()
        {
            ...
            var set = this.CreateBindingSet<AddInventoryProductView, InventoryEditViewModel>();
