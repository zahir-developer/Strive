...
{
	[Register ("AddInventoryProductView")]
	partial class AddInventoryProductView
	{
		[Outlet]
		UIKit.UIView AddImage { get; set; }
		...
		[Outlet]
		UIKit.UIButton FromCamera { get; set; }

		[Outlet]
		UIKit.UIButton FromFiles { get; set; }

		[Outlet]
		UIKit.UIButton FromIcon { get; set; }
