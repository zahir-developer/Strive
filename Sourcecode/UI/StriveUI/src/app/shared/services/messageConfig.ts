...
emailExist : 'Client Email Already Exist',
 ...
 paidTicket :'Checkout can be done only for paid tickets.'
      ...
      Admin : {
         ...
         HourFormat: 'Enter Valid 24Hours Time Format',
         ...
         TimeclockAdd: 'Employee added successfully !',
         TimeClockUpdate: 'Employee updated successfully !',
         TimeClockDelete: 'Employee record deleted successfully !',
