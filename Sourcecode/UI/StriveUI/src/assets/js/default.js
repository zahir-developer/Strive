var App = (function () {
    var t,
        ...
        f = function () {
            $("body").on("click", ".portlet > .portlet-title > .tools > a.remove", function (t) {
                ...
                $("body").on("click", ".portlet > .portlet-title > .tools > a.reload", function (t) {
                    ...
                    o
                        ? (App.blockUI({ target: e, animate: !0, overlayColor: "none" }),
                          $.ajax({
                              type: "GET",
                              cache: !1,
                              url: o,
            ...
            if (
                ...
                $("body").on("click", "a.btn, button.btn, input.btn, label.btn", function (n) {
                    (t = $(this)),
                        ...
                        e.height() || e.width() || ((o = Math.max(t.outerWidth(), t.outerHeight())), e.css({ height: o, width: o })),
                        (a = n.pageX - t.offset().left - e.width() / 2),
                        (i = n.pageY - t.offset().top - e.height() / 2),
                        e.css({ top: i + "px", left: a + "px" }).addClass("md-click-animate"),
                        setTimeout(function () {
                            e.remove();
                        }, 1e3);
                });
        ...
        g = function () {
            $().iCheck &&
                $(".icheck").each(function () {
                    ...
                    t.indexOf("_line") > -1 || e.indexOf("_line") > -1
                        ? $(this).iCheck({ checkboxClass: t, radioClass: e, insert: '<div class="icheck_line-icon"></div>' + $(this).attr("data-label") })
        ...
        x = function () {
            $(".tooltips").tooltip(),
                ...
                $(".portlet > .portlet-title > .tools > .collapse, .portlet > .portlet-title > .tools > .expand").tooltip({ trigger: "hover", container: "body", title: "Collapse/Expand" });
        },
        k = function () {
    ...
    return {
        ...
        scrollTo: function (t, e) {
            ...
            t &&
                ($("body").hasClass("page-header-fixed")
                    ? (o -= $(".page-header").height())
                    : $("body").hasClass("page-header-top-fixed")
                    ? (o -= $(".page-header-top").height())
                    : $("body").hasClass("page-header-menu-fixed") && (o -= $(".page-header-menu").height()),
                (o += e ? e : -1 * t.height())),
        ...
        blockUI: function (t) {
            ...
            if (
                ((e = t.animate
                    ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><div class="block-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>'
                    : t.iconOnly
                    ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><img src="' + this.getGlobalImgPath() + 'loading-spinner-grey.gif" align=""></div>'
                    : t.textOnly
                    ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><span>&nbsp;&nbsp;' + (t.message ? t.message : "LOADING...") + "</span></div>"
                    : '<div class="loading-message ' +
                      (t.boxed ? "loading-message-boxed" : "") +
                      '"><img src="' +
                      this.getGlobalImgPath() +
                      'loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' +
                      (t.message ? t.message : "LOADING...") +
                      "</span></div>"),
                t.target)
            ) {
                var o = $(t.target);
                o.height() <= $(window).height() && (t.cenrerY = !0),
                    o.block({
                        ...
                        overlayCSS: { backgroundColor: t.overlayColor ? t.overlayColor : "#555", opacity: t.boxed ? 0.05 : 0.1, cursor: "wait" },
                    });
            } else
                $.blockUI({
                    message: e,
        ...
        startPageLoading: function (t) {
            t && t.animate
                ? ($(".page-spinner-bar").remove(), $("body").append('<div class="page-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>'))
                : ($(".page-loading").remove(),
        ...
        alert: function (t) {
            ...
            var e = App.getUniqueID("App_alert"),
                o =
                    ...
                    t.type +
                    ' fade in">' +
                    (t.close ? '<button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>' : "") +
                    ("" !== t.icon ? '<i class="fa-lg fa fa-' + t.icon + '"></i>  ' : "") +
                    t.message +
                    "</div>";
            return (
                ...
                t.container
                    ...
                    ? $(".page-fixed-main-content").prepend(o)
                    : ($("body").hasClass("page-container-bg-solid") || $("body").hasClass("page-content-white")) && 0 === $(".page-head").size()
                    ? $(".page-title").after(o)
                    : $(".page-bar").size() > 0
                    ? $(".page-bar").after(o)
                    : $(".page-breadcrumb, .breadcrumbs").after(o),
